...
ARG VAULT_NETWORK
ARG PRESIGNED_BUILD_PROTOCOL=presigned-graph-v3
ENV VAULT_NETWORK=${VAULT_NETWORK} NEXT_PUBLIC_VAULT_NETWORK=${VAULT_NETWORK} PRESIGNED_BUILD_PROTOCOL=${PRESIGNED_BUILD_PROTOCOL}
COPY . .
